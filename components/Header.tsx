  ...
  return (
    <div className={` p-8 h-screen flex flex-col justify-between ${className}`}>
      <div className="">
        ...
        <h1 className="uppercase text-2xl sm:text-3xl md:text-[3.8rem] font-bold text-primary mb-4 -mt-1.5">
          Due Fratelli
        </h1>
      </div>
      <div className="">
        <p className="text-sm font-medium">Menu Upload Portal</p>
        <p className="text-xs sm:text-sm opacity-80">Upload new menu PDFs to update the restaurant website</p>
      </div>
    </div>
  );
}
